...
- **106 new plants** (810 → 872 after merges): Joshua Tree, Giant Sequoia, Coast Redwood, Bristlecone Pine, Baobab, Banyan, Ginkgo, Plumeria, Bougainvillea, Wisteria, Hellebore, Star Jasmine, Witch Hazel, Mountain Laurel, Medinilla, Ficus Audrey, Calathea Musaica, Philodendron Florida Ghost, Cacao, Arabica Coffee, Hemp, Jackfruit, Durian, Rambutan, Giant Water Lily, Cephalotus, Paphiopedilum, Red Prayer Plant, Pin-stripe Calathea, Graptoveria, ZZ Plant Zenzi, Begonia Amphioxus, Silver Leaf Philodendron, Silver Dragon Alocasia, Hoya Krimson Queen, Ruby Rubber Plant, Ficus Shivereana, Sweet William, Hollyhock, Dusty Miller, Statice, Ornamental Sage, Lisianthus, Garden Ranunculus, Eucalyptus, Italian Cypress, Hardy Hibiscus, Shallot, Garlic, Microgreen Mix, Globe Amaranth, Gaura, Sneezeweed, Agastache, Ornamental Kale, Scabiosa, Stock, Saguaro, Red Mangrove, Corpse Flower, Monstera Esqueleto, Hoya Cumingiana, Rafflesia, Dracaena Goldieana, Hoya Callistophylla, and more. Full metadata + EN/ES/ZH translations for all.
- **New category: Houseplants - Ficus & Rubber Trees** (7 plants split from Specialty).
...
- **Toxicity (34 corrections):** 7 plants corrected to nonToxic (portulacaria-afra, string-of-hearts, phoenix-roebelenii, hibiscus-tropical, pteris, pteris-cretica, gaillardia). 7 corrected to mildlyToxic (scindapsus ×3, tradescantia ×4) for calcium-oxalate aroid consistency. 17 critical safety fixes — daylilies, hostas, irises, hyacinth, tulips, allium ×2, cassava, senecio → toxic; chrysanthemums, gladiolus, gardenia, coleus, lavender, dianthus ×2, pine, crabapple, dahlia, epazote, mango → mildlyToxic; campanula-alpine, freesia, ixora, serviceberry, fennel-herb → nonToxic; chionodoxa → unknown.
...
- **Metadata (31 fixes):** crassula-ovata-minor watering 7→14 days; english-ivy temperature [16,21]→[10,27]; cast-iron-plant temperature [18,24]→[7,27]; bird-of-paradise humidity high→medium. Corrected watering intervals (celery, wasabi, chili-pepper, sweet-potato ×2, cassava, watercress, lotus, rice), light preferences (cast-iron-plant, moss, reindeer-moss, mushrooms ×2, oyster-mushroom), humidity (maidenhair-ferns, staghorn-fern, calathea ×6), drainage (sundew, butterwort), soil pH and other field corrections.
...
- **Category misplacements:** Moved alocasia-dragon-scale to Aroids, syngonium-white to Low Maintenance, bamboo-palm to Palms.
- **Light preferences:** Removed deprecated `gentleDirect` and `deepShade` values; normalized to standard enums.

### Changed

- **Merged 47 entries** into their more common names: burros-tail ← sedum-morganianum, string-of-dolphins ← senecio-peregrinus, maranta-prayer-plant ← maranta-leuconeura, gloxinia ← sinningia, joe-pye-weed ← sweet-joe-pye, string-of-turtles ← peperomia-prostrata, switchgrass-prairie ← panicum, luffa ← loofah, parlor-palm ← neanthe-bella-palm, philodendron-heartleaf ← philodendron-scandens + philodendron-hederaceum-scandal, vanilla-crop ← vanilla-orchid, lotus-root ← lotus, bromeliad-tillandsia ← tillandsia, giant-allium ← ornamental-allium, lily-oriental ← lily-casa-blanca, pitcher-plant ← mexican-pitcher, snow-pea ← snow-pea-sprouts, hoyas ← hoya-obovata-splash, soybeans ← edamame, staghorn-fern ← platycerium-bifurcatum, echinacea ← purple-coneflower + pale-purple-coneflower, gaillardia ← blanket-flower, goldenrod ← showy-goldenrod, ctenanthe ← ctenanthe-burle-marx + ctenanthe-golden-mosaic, stromanthe-triostar ← stromanthe-magic-star + stromanthe-trio-star, scindapsus ← scindapsus-exotica + scindapsus-treubii, philodendron-white-knight ← philodendron-white-wizard, syngonium-pink ← syngonium-pink-splash, kalanchoe ← kalanchoe-blossfeldiana, sedums ← sedum-autumn-joy + stonecrop, eggplant ← chinese-eggplant, zinnias ← zinnia-elegans, dracaena-fragrans ← dracaena-compacta, pteris ← pteris-cretica, rhipsalis ← rhipsalis-baccifera + 6 cultivar merges (gymnocalycium-hibotan, echeveria-lola, sedum-rubrotinctum, haworthia-fasciata, opuntia-santa-rita, tradescantia-nanouk). Alternate names preserved as "Also known as" in descriptions.
- **34 boilerplate careTips replaced** with plant-specific content (EN/ES/ZH): 18 fruit entries (banana, boysenberry, coconut, currant, dates, gooseberry, guava, kiwi, mango, mulberry, olive, papaya, passion-fruit, pawpaw, pineapple, prickly-pear-fruit, quince, watermelon-yellow) + 15 herb entries (borage, catnip, chamomile, chervil, epazote, holy-basil, lemon-balm, lovage, marjoram, savory, shiso, sorrel, stevia, tarragon, vietnamese-coriander) + coleus.
- **EN content quality:** 71 entries optimized — 4 short descriptions enriched; 20 prairie wildflowers, 3 European wildflowers, 3 perennials, and 41 sprout/microgreen entries given species-specific care tips (zero identical care tips remaining).
- **ZH-Hans translation quality:** 135 entries optimized — replaced generic placeholder descriptions and care tips with expert Chinese translations for farm crops, sprouts/microgreens, prairie perennials, and grasses.
- **ES translation quality:** 112 entries optimized — replaced generic placeholder descriptions and care tips with expert Spanish translations for sprouts/microgreens, prairie perennials, leafy greens, and mixed perennials.
- **3 existing entries enhanced** with richer content (impatiens, yarrow, celosia).
- **Renamed 6 IDs:** common-viper → vipers-bugloss, alocasia-mahorani → alocasia-maharani (spelling fix), purple-cone-prairie → prairie-coneflower, chinese-evergreen-maria → aglaonema-maria, chinese-evergreen-silver → aglaonema-silver-bay (Aglaonema naming standardized), bamboo-palm-aquatic → umbrella-palm.
...
- **Category restructure:** Split "Houseplants - Specialty" → new "Houseplants - Ficus & Rubber Trees" (7 plants). 29 categories total.
